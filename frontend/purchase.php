...
<body>
    ...
    // Check if the form is submitted and if the 'purchase' button is clicked
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST['purchase'])) {
            ...
            // Insert order information into order_manager table
            ...
            if (mysqli_query($conn, $query1)) {
                ...
                // Insert individual items into online_orders_new table
                ...
                if ($stmt) {
                    ...
                    foreach ($_SESSION['cart'] as $key => $values) {
                        ...
                        // Update stock quantity of food items
